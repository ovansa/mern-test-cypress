...
describe('ADD TODO SCENARIOS', function () {
    ...
    it('Todo can be created by entering only description field: Validate that the Description text\
    ...
    it('Todo can be created by entering only responsible field: Validate that the Responsible text\
    ...
    it('Adding a todo by selecting all fields is successful: Validate that description, responsible, \
